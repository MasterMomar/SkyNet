...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-exclamation-circle"></i> Browsing Errors</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Browsing Errors</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
...
?>>Display Errors</option>
				        ...
				        <div class="card">
						<div class="card-header">
							<h3 class="card-title"><i class="fas fa-clipboard-list"></i> Browsing Errors</h3>
						</div>
						<div class="card-body">
<?php
...
?>
						...
						<div class="card-body">
									Logging errors is recommended best practice, even for production site. Checking those logs however might seem like a chore. The Browsing Errors brings all entries from error log on this page.<br /><br />
                                    <ul>
