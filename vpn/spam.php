...
?>
						<div class="card-header">
							<h3 class="card-title">Spam Attack - Protection Module</h3>
						</div>
...
?>
                    ...
                    <div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title"><i class="fas fa-server"></i> Spam Attack Databases (DNSBL)</h3>
						</div>
						<div class="card-body">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-dark">
					<h6 class="modal-title">Add Spam Attack Database (DNSBL)</h6>
...
?>
                ...
                <div class="col-md-4">
                     <div class="card card-dark">
                        	<div class="card-header">
								<h3 class="card-title"><i class="fas fa-info-circle"></i> What is Spam Attack & DNSBL</h3>
							</div>
							<div class="card-body">
