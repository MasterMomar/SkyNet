...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-filter"></i> Protection Module</h1>
        		    </div>
        		    <div class="col-sm-6">
...
?>
						<div class="card-header">
							<h3 class="card-title">Text/Words Audit  - Protection Module</h3>
						</div>
...
if ($countfc > 0) {
    echo '
        ...
        <p>The Text/Words Audit  are <strong>Filtered</strong></p>
';
} else {
    echo '
        <h1 style="color: #007bff;"><i class="fas fa-times-circle"></i> Disabled</h1>
        <p>The Text/Words Audit  are not <strong>Filtered</strong></p>
';
}
?>
                        </div>
                    ...
                    <div class="card">
						<div class="card-header">
							<h3 class="card-title">Text/Words Audit </h3>
						</div>
						<div class="card-body">
...
?>
                ...
                <div class="col-md-4">
                     <div class="card card-dark">
                        	<div class="card-header">
								<h3 class="card-title"><i class="fas fa-info-circle"></i> About Text/Words Audit  Filtering</h3>
							</div>
							<div class="card-body">
                                This module can be used to censore (hide, replace) Text/Words Audit , links and sentences.
								<br /><br />
								If there are no Text/Words Audit  added the module is automatically disabled. 
								<br /><br />
								The module is working in two ways:
								<ul>
								  <li>Filtering Text/Words Audit  in real-time before Output (Page Rendering)</li>
								  <li>Filtering Text/Words Audit  after POST data is submitted</li>
								</ul>
