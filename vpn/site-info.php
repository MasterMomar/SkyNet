...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-info-circle"></i> Host Information
...
?>
                ...
                <div class="col-md-12">
                    <h3 class="mt-none text-white">Host Information</h3>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/DNS_IP_Address.png" class="wi-45">
									<hr>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/Country.png" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
echo $host_country;
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/ProxyAttackSNicn.png" class="wi-45">
									<hr>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/isp.png" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
echo $host_isp;
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/ServerOS.png" class="wi-45">
									<hr>
									<p class="h4 text-thin">
<?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/php-icon.jpg" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
echo phpversion();
?></p>
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/Home-Server-icon.png" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/PortResultsSNicon.png" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/opensslversion.png" class="wi-45">
									<hr>
									<p class="h4 text-thin">
<?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/CuRLExtension.png" class="wi-45">
									<hr>
									<p class="h4 text-thin">
<?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/http-icon.jpg" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
                       ...
                       <div class="col-md-3">
							<div class="card">
								<div class="card-body text-center">
									...
									<img src="assets/img/Netwrk_Gateway.png" class="wi-45">
									<hr>
									<p class="h4 text-thin"><?php
