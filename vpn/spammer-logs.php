...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-align-justify"></i> Spam Overload Logs</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Spam Overload Logs</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
				...
				<div class="col-md-12">
				    ...
				    <div class="card card-dark">
						<div class="card-header">
							<h3 class="card-title">Spam Overload Logs</h3>
						</div>
						<div class="card-body">
