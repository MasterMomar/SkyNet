...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-flag"></i> Approved Files</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Approved Files</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
...
?></textarea>
                        ...
                        <div class="card-footer row">
							<div class="col-md-8">
								<button class="btn btn-block btn-flat btn-aside" name="edit" type="submit">Save</button>
							</div>
							<div class="col-md-4">
...
?>
				    ...
				    <div class="card card-dark">
						<div class="card-header">
							<h3 class="card-title">Approved Files</h3>
						</div>
						<div class="card-body">
