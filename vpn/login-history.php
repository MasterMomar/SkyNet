...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-history"></i> Login History</h1>
        		    </div>
        		    <div class="col-sm-6">
...
while ($row = $query->fetch_assoc()) {
    ...
    echo '
											...
											<td>
                                            <a href="search.php?ip=' . $row['ip'] . '" class="btn btn-flat btn-flat btn-aside"><i class="fas fa-search"></i> IP Lookup</a>
											</td>
										</tr>
';
}
