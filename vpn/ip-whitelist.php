...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-flag"></i> Approved IP Addresses</h1>
        		    </div>
        		    <div class="col-sm-6">
        		      <ol class="breadcrumb float-sm-right">
        		        <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Admin Panel</a></li>
        		        <li class="breadcrumb-item active">Approved IP Addresses</li>
        		      </ol>
        		    </div>
        		  </div>
    			</div>
...
?></textarea>
                        ...
                        <div class="card-footer row">
							<div class="col-md-8">
								<button class="btn btn-block btn-flat btn-aside" name="edit" type="submit"><i class="fas fa-save"></i> Save</button>
							</div>
							<div class="col-md-4">
...
?>
				    ...
				    <div class="card card-dark">
						<div class="card-header">
							<h3 class="card-title">Approved IP Addresses</h3>
						</div>
						<div class="card-body">
...
while ($row = $query->fetch_assoc()) {
    echo '
										<tr>
											...
											<td>' . $row['notes'] . '</td>
											<td>
                                            <a href="?edit-id=' . $row['id'] . '" class="btn btn-flat btn-flat btn-secondary"><i class="fas fa-edit"></i> Edit</a>
...
?>
				...
				<div class="col-md-3">
				     <div class="card card-dark">
						<div class="card-header">
							<h3 class="card-title">List the IP Addresses you trust to connect to your device or Network (Privately)</h3>
						</div>
				        <div class="card-body">
						<form class="form-horizontal" action="" method="post">
								<div class="form-group">
                        ...
                        <div class="card-footer">
							<button class="btn btn-block btn-flat btn-aside" name="add" type="submit"><i class="fas fa-plus-square"></i> Add</button>
				        </div>
				     </div>
</form>
