...
<div class="content-wrapper">
			...
			<div class="content-header">
				...
				<div class="container-fluid">
				  <div class="row mb-2">
        		    <div class="col-sm-6">
        		      <h1 class="m-0 text-white"><i class="fas fa-code"></i> Protection Module</h1>
        		    </div>
        		    <div class="col-sm-6">
...
?>
						<div class="card-header">
							<h3 class="card-title">Bot Attacks - Protection Module</h3>
						</div>
...
if ($row['protection'] == 1 OR $row['protection2'] == 1 OR $row['protection3'] == 1) {
    echo '
        ...
        <p>The website is protected from <strong>Bot Attacks</strong></p>
';
} else {
    echo '
        <h1 style="color: #d2322d;"><i class="fas fa-times-circle"></i> Disabled</h1>
        <p>The website is not protected from <strong>Bot Attacks</strong></p>
';
}
?>
                        </div>
							...
							<div class="card-body">
                        	    <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <center>
                                        <h5>Bot Attacks</h5><hr />
                                        Detects the <b>Bot Attacks</b> and blocks their access to the website
                                        <br /><br />
...
?> />
                ...
                <div class="col-md-4">
                     <div class="card card-dark">
                        	<div class="card-header">
								<h3 class="card-title"><i class="fas fa-info-circle"></i> What is Bot Attack</h3>
							</div>
							<div class="card-body">
